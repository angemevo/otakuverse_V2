...
class _ProfileScreenState extends State<ProfileScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      final posts = await _postService.getPostsByUser(targetId);
      ...
      builder: (_) => Column(
        ...
        children: [
          ...
          Container(width: 40, height: 4,
            decoration: BoxDecoration(color: AppColors.mediumGray, borderRadius: BorderRadius.circular(2))),
          ...
          _settingsItem(Icons.lock_outline, 'Changer le mot de passe', () => Navigator.pop(context)),
          _settingsItem(Icons.notifications_outlined, 'Notifications', () => Navigator.pop(context)),
          _settingsItem(Icons.privacy_tip_outlined, 'Confidentialité', () => Navigator.pop(context)),
  ...
  Widget _settingsItem(IconData icon, String label, VoidCallback onTap, {Color? color}) {
    return ListTile(
      ...
      title: Text(label, style: GoogleFonts.inter(color: color ?? AppColors.pureWhite, fontSize: 15)),
      trailing: color == null ? const Icon(Icons.arrow_forward_ios, color: AppColors.mediumGray, size: 14) : null,
      onTap: onTap,
    );
  }
  ...
  void _showLogoutConfirmation() {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        title: Text('Se déconnecter ?', style: GoogleFonts.poppins(color: AppColors.pureWhite, fontWeight: FontWeight.w600)),
        content: Text('Tu seras redirigé vers la page de connexion.', style: GoogleFonts.inter(color: AppColors.mediumGray)),
        actions: [
  ...
  Widget build(BuildContext context) {
      ...
      return Scaffold(
        ...
        body: Center(child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text('Profil introuvable', style: GoogleFonts.poppins(color: AppColors.pureWhite, fontSize: 20, fontWeight: FontWeight.w600)),
            TextButton(onPressed: _loadData, child: Text('Réessayer', style: GoogleFonts.inter(color: AppColors.crimsonRed))),
          ],
        )),
      );
    }
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        color: AppColors.crimsonRed, backgroundColor: AppColors.darkGray,
        onRefresh: _loadData,
          ...
          headerSliverBuilder: (_, __) => [
            ...
            SliverPersistentHeader(
              ...
              delegate: _TabBarDelegate(TabBar(
                ...
                indicatorColor: AppColors.crimsonRed, indicatorWeight: 3,
                labelColor: AppColors.crimsonRed, unselectedLabelColor: AppColors.mediumGray,
                labelStyle: GoogleFonts.inter(fontWeight: FontWeight.w600, fontSize: 13),
                unselectedLabelStyle: GoogleFonts.inter(fontSize: 13),
                tabs: const [Tab(text: 'Posts'), Tab(text: 'À propos'), Tab(text: 'Animés'), Tab(text: 'Likes')],
              )),
            ),
          ],
          body: TabBarView(
            controller: _tabController,
            children: [_buildPostsTab(), _buildAboutTab(), _buildAnimesTab(), _buildLikesTab()],
          ),
        ),
      ),
    );
  ...
  Widget _buildSliverAppBar() {
    return SliverAppBar(
      expandedHeight: 200, backgroundColor: AppColors.deepBlack,
      automaticallyImplyLeading: false, pinned: true, elevation: 0,
          ...
          Positioned(
            ...
            child: Row(
              ...
              children: [
                Stack(children: [
                  Container(
                    decoration: BoxDecoration(shape: BoxShape.circle, border: Border.all(color: AppColors.crimsonRed, width: 3)),
                    child: CircleAvatar(
                      radius: 36, backgroundColor: AppColors.darkGray,
                      backgroundImage: _profile!.hasAvatar ? NetworkImage(_profile!.avatarUrl!) : null,
                      child: !_profile!.hasAvatar ? const Icon(Icons.person, color: AppColors.pureWhite, size: 32) : null,
                    ),
                  ),
                  if (_isMe) Positioned(
                    bottom: 0, right: 0,
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: const BoxDecoration(color: AppColors.crimsonRed, shape: BoxShape.circle),
  ...
  Widget _buildActionButton(String label, {required VoidCallback onTap, bool outlined = false}) {
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: outlined ? AppColors.pureWhite : AppColors.crimsonRed, width: 2),
        ),
        child: Text(label, style: GoogleFonts.inter(color: AppColors.pureWhite, fontWeight: FontWeight.w700, fontSize: 14)),
      ),
    );
  }
        ...
        children: [
          Row(children: [
            Text(_profile!.displayNameOrUsername,
                style: GoogleFonts.poppins(color: AppColors.pureWhite, fontSize: 22, fontWeight: FontWeight.bold)),
          ...
          if (_profile!.location != null || _profile!.website != null) ...[
            ...
            Row(children: [
              if (_profile!.location != null) ...[
                ...
                Text(_profile!.location!, style: GoogleFonts.inter(color: AppColors.mediumGray, fontSize: 13)),
                const SizedBox(width: 12),
              ],
              if (_profile!.website != null) ...[
                const Icon(Icons.link, color: AppColors.crimsonRed, size: 14),
                const SizedBox(width: 4),
                Text(_profile!.website!, style: GoogleFonts.inter(color: AppColors.crimsonRed, fontSize: 13, decoration: TextDecoration.underline, decorationColor: AppColors.crimsonRed)),
              ],
            ]),
          ],
        ],
    ...
    return Padding(
      ...
      child: Row(children: [
        ...
        RichText(text: TextSpan(children: [
          TextSpan(text: '${_profile!.followersCount}', style: GoogleFonts.inter(color: AppColors.pureWhite, fontWeight: FontWeight.w700, fontSize: 14)),
          TextSpan(text: ' Abonnés', style: GoogleFonts.inter(color: AppColors.mediumGray, fontSize: 14)),
        ])),
        const SizedBox(width: 16),
        RichText(text: TextSpan(children: [
          TextSpan(text: '${_profile!.postsCount}', style: GoogleFonts.inter(color: AppColors.pureWhite, fontWeight: FontWeight.w700, fontSize: 14)),
          TextSpan(text: ' Posts', style: GoogleFonts.inter(color: AppColors.mediumGray, fontSize: 14)),
        ])),
      ]),
    );
  }
  ...
  Widget _buildBio() {
    ...
    return Padding(
      padding: const EdgeInsets.fromLTRB(16, 10, 16, 0),
      child: Text(_profile!.bio!, style: GoogleFonts.inter(color: AppColors.lightGray, fontSize: 14, height: 1.5)),
    );
  }
  ...
  Widget _buildGenres() {
    return Padding(
      ...
      child: Wrap(spacing: 8, runSpacing: 8,
        children: _profile!.favoriteGenres.map((g) => Container(
          padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 4),
          decoration: BoxDecoration(
            color: AppColors.crimsonWithOpacity(0.1), borderRadius: BorderRadius.circular(20),
            border: Border.all(color: AppColors.crimsonWithOpacity(0.4)),
          ),
          child: Text('#$g', style: GoogleFonts.inter(color: AppColors.lightCrimson, fontSize: 12, fontWeight: FontWeight.w500)),
        )).toList(),
      ),
    );
  }
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            Text('Aucun post', style: GoogleFonts.inter(color: AppColors.mediumGray)),
          ],
        ),
      );
    }
        ...
        children: [
              ...
              children: [
                ...
                if (_isMe)
                  PopupMenuButton<String>(
                    color: AppColors.darkGray,
                    icon: const Icon(Icons.more_horiz, color: AppColors.mediumGray),
              ...
              child: Image.network(
                ...
                errorBuilder: (_, __, ___) => Container(
                  ...
                  child: const Icon(Icons.broken_image,
                      color: AppColors.pureWhite, size: 48),
                ),
              ),
            ),
          ...
          Padding(
            ...
            child: Row(
              children: [
                _actionButton(
                    Icons.favorite_border, '${post.likesCount}', AppColors.crimsonRed),
                const SizedBox(width: 16),
                _actionButton(
                    Icons.chat_bubble_outline, '${post.commentsCount}', AppColors.mediumGray),
                const Spacer(),
                _actionButton(
                    Icons.share_outlined, 'Partager', AppColors.mediumGray),
              ],
            ),
          ),
        ],
