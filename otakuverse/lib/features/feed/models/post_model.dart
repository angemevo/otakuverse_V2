class PostModel {
  ...
  // ─── Données dénormalisées depuis profiles (join Supabase) ───────
  // Ces champs sont populés via .select('*, profiles(username, avatar_url)')
  ...
  String get displayUsername => username ?? 'Utilisateur';

  // ─── FACTORY depuis JSON Supabase ────────────────────────────────
  factory PostModel.fromJson(Map<String, dynamic> json) {
    // Gestion du join profiles (optionnel)
